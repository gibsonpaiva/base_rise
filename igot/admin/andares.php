...
<?php
    ...
    // Listagem dos Andares
    $itens = $db_igot->getAndares();
    // Montagem das linhas da tabela
    $postURL = "'ajax/updAndares.php'"; // Endereço da página com as funções SQL desta Base de Dados / Tabela
    $tr_table = "";
        ...
        $tr_table .= '
            <tr id="'.$itens[$i]['id'].'" name="'.$itens[$i]['id'].'">
                ...
                <td class="datagrid" align="center">
                    <span class="viewOnly Andar">'.$itens[$i]['Andar'].'</span>
                    <input class="editInput form-control input-sm" type="text" name="Andar" value="'.$itens[$i]['Andar'].'" style="display: none;">
                </td>
                <td class="datagrid">
                ...
                <td class="datagrid" align="center">
                    <span class="viewOnly MedalhasConceder">'.$itens[$i]['MedalhasConceder'].'</span>
                    <input class="editInput form-control input-sm" type="text" name="MedalhasConceder" value="'.$itens[$i]['MedalhasConceder'].'" style="display: none;">
                </td>
                <td class="datagrid" align="center">
                    <span class="viewOnly MedalhasAcumuladas">'.$itens[$i]['MedalhasAcumuladas'].'</span>
                    <input class="editInput form-control input-sm" type="text" name="MedalhasAcumuladas" value="'.$itens[$i]['MedalhasAcumuladas'].'" style="display: none;">
                </td>
                <td class="datagrid actions" align="center">
                    <button onClick="EditAndar(this.id)" id="btnEdit'.$itens[$i]['id'].'" type="button" class="btn btn-sm btn-default btnEdit" style="float:none;"><span class="glyphicon glyphicon-pencil"></span></button>
                                                ...
                                                <table class="table table-bordered table-hover table-striped dataTable" role="grid" id="tblDataGrid">
                                                    <thead>
                                                        <tr role="row" class="tblTitleRow">
                                                            ...
                                                            <th class="datagrid">Andar</th>
                                                            <th class="datagrid">Patente</th>
                                                            <th class="datagrid">Medalhas a Conceder</th>
                                                            <th class="datagrid">Medalhas Acumuladas</th>
        ...
        <script>
            ...
            function New(){
                ...
                '<tr class="ui-sortable-handle" id="NewRecord">'
                    ...
                    +'</td>'
                    +'<td class="datagrid" align="center">'
                        +'<span class="viewOnly Andar" style="display:none;"></span>'
                        +'<input class="editInput form-control input-sm" type="text" name="Andar">'
                    +'</td>'
                    +'<td class="datagrid">'
                        +'<span class="viewOnly Nome" style="display:none;"></span>'
                        +'<input class="editInput form-control input-sm" type="text" name="Nome">'
                    +'</td>'
                    +'<td class="datagrid" align="center">'
                        +'<span class="viewOnly MedalhasConceder" style="display:none;"></span>'
                        +'<input class="editInput form-control input-sm" type="text" name="MedalhasConceder">'
                    +'</td>'
                    +'<td class="datagrid" align="center">'
                        +'<span class="viewOnly MedalhasAcumuladas" style="display:none;"></span>'
                        +'<input class="editInput form-control input-sm" type="text" name="MedalhasAcumuladas">'
                    +'</td>'
                    +'<td class="datagrid actions" align="center">'
                        +'<button onClick="EditAndar(this.id)" id="btnEdit" type="button" class="btn btn-sm btn-default btnEdit" style="float:none; display:none;"><span class="glyphicon glyphicon-pencil"></span></button>'
            ...
            function SaveNew(){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        trObj.find(".viewOnly.Andar").text(response.data.andar);
                        trObj.find(".viewOnly.Nome").text(response.data.nome);
                        trObj.find(".viewOnly.MedalhasConceder").text(response.data.MedalhasConceder);
                        trObj.find(".viewOnly.MedalhasAcumuladas").text(response.data.MedalhasAcumuladas);
