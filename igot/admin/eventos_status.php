...
<?php
    ...
    // Listagem dos Status de Eventos
    $itens = $db_igot->getEventosStatus();
    // Montagem das linhas da tabela
    $postURL = "'ajax/updEventosStatus.php'"; // Endereço da página com as funções SQL desta Base de Dados / Tabela
    $tr_table = "";
