...
<html>
    ...
    <body class="hold-transition skin-red sidebar-mini fixed">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-header">
                                    <h3 class="box-title">Conformidades</h3>
                                </div>
                                <!-- Conteúdo da Caixa -->
                                <div class="box-body">
                                    <!-- Filtro -->
                                                ...
                                                <table class="table table-bordered table-hover table-striped dataTable" role="grid" id="tblDataGrid">
                                                    <thead id="thDataGrid">
                                                        <tr role="row" class="tblTitleRow">
                                                            ...
                                                            <th class="sorting datagrid" onclick="Sort(this, 'thDataGrid', 'show')" col="Conformidade">Nome</th>
                                                            <th class="sorting datagrid" onclick="Sort(this, 'thDataGrid', 'show')" col="TipoConformidade">Tipo</th>
        ...
        <script>
            ...
            function show(sort="Conformidade"){
                ...
                table.open("GET", '../config/results.php?return=Conformidades&type=DataGrid&sort='+sort+filtro, true);
                table.send();
        ...
        <script>
            ...
            function New(){
                ...
                '<tr class="ui-sortable-handle" id="NewRecord">'
                    ...
                    +'<td class="datagrid">'
                        ...
                        +'<input class="editInput form-control input-sm" type="text" name="Tipo">'
                    +'</td>'
            ...
            function EditConformidade(btnID){
