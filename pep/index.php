        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">                    
                    ...
                    <h4><b>ARQUITETURA DE IMPLEMENTAÇÃO</b></h4>
                            ...
                            <div class="col-xs-12">
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                       ...
                                       <li><a href="#PlanoArquitetura" data-toggle="tab">PLANO ARQUITETURA</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <?php
                                            ...
                                            // Documentos
                                            include_once "frames/documentos.php";
                                            // Plano de Arquitetura
                                            include_once "frames/plano_arquitetura.php";                                          
                                        ?>    
                                    </div>
                                </div>
                            </div>
